<script lang="ts">
  ...
  const { node, getLink, title, icon, extra }: Props = $props();
...
<nav class="flex items-center py-2">
  ...
  <div
    class="bg-gray-50 dark:bg-immich-dark-gray/50 w-full p-2 rounded-2xl border border-gray-100 dark:border-gray-900 flex items-center gap-2"
  >
    <div class="overflow-x-auto immich-scrollbar flex-1">
